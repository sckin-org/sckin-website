> RETIRED (2026-07-22). This document is no longer a decision or content source. Status and decisions: sckin-website-requirements.md. Design: docs/sckin-design-spec-phase1.md. Page copy source of truth: content/*.md. Kept for historical reference only.
